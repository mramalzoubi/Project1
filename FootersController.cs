...
namespace Yogagym.Controllers
{
    public class FootersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Location,Name,Copyright,Linkinstagram,Linkfacebook,Linkx")] Footer footer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Location,Name,Copyright,Linkinstagram,Linkfacebook,Linkx")] Footer footer)
        {
            if (id != footer.Id)
            {
                return NotFound();
